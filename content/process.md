---
title: Transparent and Open BCP Development Process for GCVE 
---

## Overview

The GCVE project follows a fully transparent and traceable process for developing **[Best Current Practices (BCPs)](https://gcve.eu/bcp/)**.
...
👉 All BCP GCVE discussions are available at [https://discourse.ossbase.org/c/gcve/14](https://discourse.ossbase.org/c/gcve/14)
...
As an example, BCP-05 (thread: 121) overall discussion can be exported at the following url: [https://discourse.ossbase.org/raw/121](https://discourse.ossbase.org/raw/121).
...
- **Complete historical traceability**
  Every message, edit, and decision is timestamped and preserved.

- **Transparent governance**
  Anyone can follow how a BCP evolved from idea to accepted practice.

- **Accountability and clarity**
  Contributors, reviewers, and decision points are visible and attributable.
